    ...
    <>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#0f1629] rounded-xl border border-white/10 overflow-hidden hover:border-cyan-400 transition">
            ...
            <div className="p-5">
              ...
              <p className="text-sm text-gray-400 mt-2">
                A  trek management application with 
                updates about trekking routes, packages for trekkers and multiple trekking options.
              </p>
              <div className="flex gap-2 flex-wrap mt-4 text-xs text-gray-300">
                <span>HTML5</span>
                <span>CSS3</span>
          ...
          <div className="bg-[#0f1629] rounded-xl border border-white/10 overflow-hidden hover:border-cyan-400 transition">
            ...
            <div className="p-5">
              ...
              <p className="text-sm text-gray-400 mt-2">
                  An online trip planner system that allows users to plan and organize their trips effectively.
              </p>
              <div className="flex gap-2 flex-wrap mt-4 text-xs text-gray-300">
                <span>REACT Js</span>
                <span>Tailwind CSS</span>
        ...
        <div className="text-center mt-14">
          <a href='https://github.com/Niresh-sh'  className="border border-white/20 px-6 py-3 rounded-lg hover:border-cyan-400 transition">
            View More on GitHub
          </a>
        </div>
      </div>
